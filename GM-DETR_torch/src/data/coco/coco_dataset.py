...
# - torchvision<=0.18: torchvision.datapoints exists
# - torchvision>=0.19: use torchvision.tv_tensors instead
# =========================
try:
    from torchvision import datapoints  # old API
except Exception:
    from torchvision import tv_tensors as datapoints  # new API

    # tv_tensors uses BoundingBoxes (plural) not BoundingBox (singular)
    if hasattr(datapoints, "BoundingBoxes") and not hasattr(datapoints, "BoundingBox"):
